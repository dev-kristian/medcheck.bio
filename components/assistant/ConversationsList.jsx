...
const ConversationsList = ({ setActiveTab }) => {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto p-2 bg-gray-100 rounded-l-3xl rounded-r-3xl lg:rounded-r-none lg:rounded-l-3xl lg:shadow-xl relative">
      <Button 
