...
const openai = new OpenAI({
  apiKey: "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",
});
...
const BiomarkerReport = z.object({
 ...
 async function extractAndInterpretBiomarkers(imagePaths) {
   const results = [];
   ...
   console.log('Grouped Biomarker Reports:');
 ...
 const imagePaths = [
   ...
   path.join(__dirname, './test2.png'),
   // Add more image paths as needed
 ];
 extractAndInterpretBiomarkers(imagePaths);
